...
I write clean, purposeful code — from low-level systems work in **C++** to scalable Python APIs and full-stack Java applications. I care about correctness, performance, and maintainability.

```text
🎯 Currently:       Building something interesting
📚 Learning:        Always
💬 Ask me about:    System design, APIs, backend architecture
```
